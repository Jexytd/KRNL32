...
s3:Dropdown('ESP Type', {'Static', 'Dynamic'}, ESP.ESPType,'EType', function(t)
    ESP:setESPType(t)
end)
...
s3:Dropdown('Box Type', {'Default', 'Corner'}, ESP.BoxType,'EType2', function(t)
    ESP:setBoxType(t)
end)

s3:Toggle('HP', false, 'EHP', function(t)
    ESP:showHP(t)
end)
s3:Dropdown('HP Type', {'Default', 'Bar'}, ESP.HPType,'EType3', function(t)
    ESP:setHPType(t)
end)
s3:Dropdown('HP Position', {'Top', 'Bottom', 'Left', 'Right'}, ESP.HPPos,'EPos3', function(t)
    ESP:setHPPos(t)
end)

s3:Toggle('Name', false, 'EName', function(t)
    ESP:showUsername(t)
end)
s3:Dropdown('Name Position', {'Top', 'Bottom', 'Left', 'Right'}, ESP.UsernamePos,'EPos4', function(t)
    ESP:setUsernamePos(t)
end)

s3:Toggle('Distance', false, 'EDistance', function(t)
    ESP:showDistance(t)
end)
s3:Dropdown('Distance Position', {'Top', 'Bottom', 'Left', 'Right'}, ESP.DistancePos,'EPos5', function(t)
    ESP:setDistancePos(t)
end)

s3:Toggle('Tracer', false, 'ETracer', function(t)
    ESP:showTracer(t)
end)
s3:Dropdown('Tracer Type', {'FromScreen', 'FromMouse', 'FromCharacter'}, ESP.TracerType,'EType3', function(t)
    ESP:setTracerType(t)
end)
...
s3s:Slider("TextSize", 1,34,ESP.TextSize,1,"ASSmooth", function(t)
    ESP:setTextSize(t)
end)

s3s:Colorpicker("ESP Color", ESP.Color,"FOVPicker", function(t)
    ESP:setColor(t)
end)