...
xpcall(function()
    ...
    repeat
        ...
        elseif Step == 3 then
            ...
            if attempt ~= true then
                ...
                _KRNL32_[-math.huge][_KRNL32_[1][2]](Step, err_msg .. '\nScript url: ' .. githubFormat .. '\nPlaceid: ' .. tostring(game.PlaceId))
                no_error = false
            end
            if no_error then
    ...
    _KRNL32_[-math.huge][_KRNL32_[1][2]]('Loader Error Handler', msg)
    getgenv().lIlIlIlI:Remove()
    getgenv().lIlIlIlI = nil
    getgenv().ENGINE_l = nil
end)
